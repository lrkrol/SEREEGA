% h = data_plot_signal_fromclass(class, epochs, varargin)
%
%       Plots a data class activation signal. Only plots the first epoch.
%
% In:
...
%       >> data_plot_signal_fromclass(dataclass, epochs);
% 
%                    Copyright 2017 Laurens R Krol
%                    Team PhyPA, Biological Psychology and Neuroergonomics,
%                    Berlin Institute of Technology

% 2016-10-24 First version
...
function h = data_plot_signal_fromclass(class, epochs, varargin)
